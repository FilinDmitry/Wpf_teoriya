...
Тесты авторизации были пройдены успешно и не вызвали ошибок.

Тестирование регистрации выявило ряд ошибок:
...
|-------|-----------------|------------|
| `Check_user` | `public` | Авторизация пользователя |
| `New_user` | `public` | Регистрация пользователя |
| `Update` | `private` | Сохранение нового пользователя |
| `Emailvalidation` | `private` | Проверка корректности email |
